...
},{"./internal":"../node_modules/svelte/internal/index.mjs"}],"C:/Users/llej/AppData/Roaming/npm/node_modules/parcel/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"C:/Users/llej/AppData/Roaming/npm/node_modules/parcel/src/builtins/bundle-url.js"}],"request_agent_interface.svelte":[function(require,module,exports) {
"use strict";
...
/* request_agent_interface.svelte generated by Svelte v3.23.2 */
const file = "request_agent_interface.svelte";
...
function create_fragment(ctx) {
  ...
  const block = {
    c: function create() {
      ...
      (0, _internal.add_location)(button0, file, 21, 2, 472);
      (0, _internal.attr_dev)(textarea, "name", "");
      (0, _internal.attr_dev)(textarea, "id", "");
      (0, _internal.attr_dev)(textarea, "cols", "30");
      (0, _internal.attr_dev)(textarea, "rows", "10");
      (0, _internal.add_location)(textarea, file, 27, 2, 593);
      (0, _internal.add_location)(button1, file, 28, 2, 661);
      (0, _internal.attr_dev)(div, "class", "llej-request_agent_interface svelte-6aqg54");
      (0, _internal.attr_dev)(div, "style", div_style_value =
      /*launchedIn*/
      ctx[2] ? "" : "height:25px;width:50px");
      (0, _internal.add_location)(div, file, 20, 0, 375);
    },
    ...
    m: function mount(target, anchor) {
      ...
      (0, _internal.append_dev)(button0, t0);
      (0, _internal.append_dev)(div, t1);
      (0, _internal.append_dev)(div, textarea);
      ...
      if (!mounted) {
        ...
        /*click_handler*/
        ctx[4], false, false, false), (0, _internal.listen_dev)(textarea, "input",
        /*textarea_input_handler*/
        ctx[5]), (0, _internal.listen_dev)(button1, "click",
        /*click_handler_1*/
    ...
    p: function update(ctx, [dirty]) {
      ...
      4 && t0_value !== (t0_value = (
      /*launchedIn*/
      ctx[2] ? "收起" : "展开") + "")) (0, _internal.set_data_dev)(t0, t0_value);
...
function instance($$self, $$props, $$invalidate) {
  ...
  const writable_props = ["setProcessingMethod", "defaultCode"];
  Object.keys($$props).forEach(key => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Request_agent_interface> was created with unknown prop '${key}'`);
  });
  let {
    $$slots = {},
    $$scope
  } = $$props;
  (0, _internal.validate_slots)("Request_agent_interface", $$slots, []);
  ...
  $$self.$inject_state = $$props => {
    ...
    if ("launchedIn" in $$props) $$invalidate(2, launchedIn = $$props.launchedIn);
  };
...
class Request_agent_interface extends _internal.SvelteComponentDev {
  constructor(options) {
    super(options);
    ...
    (0, _internal.dispatch_dev)("SvelteRegisterComponent", {
      component: this,
      tagName: "Request_agent_interface",
      options,
      id: create_fragment.name
    });
    const {
    ...
    if (
    /*setProcessingMethod*/
    ctx[0] === undefined && !("setProcessingMethod" in props)) {
      console.warn("<Request_agent_interface> was created without expected prop 'setProcessingMethod'");
    }

    if (
    /*defaultCode*/
    ctx[3] === undefined && !("defaultCode" in props)) {
      console.warn("<Request_agent_interface> was created without expected prop 'defaultCode'");
    }
  }

  get setProcessingMethod() {
    throw new Error("<Request_agent_interface>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }

  set setProcessingMethod(value) {
    throw new Error("<Request_agent_interface>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
  }
...
},{"svelte/internal":"../node_modules/svelte/internal/index.mjs","svelte":"../node_modules/svelte/index.mjs","_css_loader":"C:/Users/llej/AppData/Roaming/npm/node_modules/parcel/src/builtins/css-loader.js"}],"../node_modules/ajax-hook/src/xhr-hook.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/ajax-hook/src/xhr-proxy.js":[function(require,module,exports) {
"use strict";
...
},{"./xhr-hook":"../node_modules/ajax-hook/src/xhr-hook.js"}],"../node_modules/ajax-hook/index.js":[function(require,module,exports) {
"use strict";
...
},{"./src/xhr-hook":"../node_modules/ajax-hook/src/xhr-hook.js","./src/xhr-proxy":"../node_modules/ajax-hook/src/xhr-proxy.js"}],"请求代理.user.ts":[function(require,module,exports) {
"use strict";
...
(function () {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    document.body.appendChild(app_div); // console.log("[app_div]", App, app_div);
...
},{"./request_agent_interface.svelte":"request_agent_interface.svelte","ajax-hook":"../node_modules/ajax-hook/index.js"}],"C:/Users/llej/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
